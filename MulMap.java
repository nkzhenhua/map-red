...
public class MulMap extends org.apache.hadoop.record.Record {
  ...
  static {
    _rio_recTypeInfo = new org.apache.hadoop.record.meta.RecordTypeInfo("MulMap");
  ...
  public int compareTo (final Object _rio_peer_) throws ClassCastException {
    if (!(_rio_peer_ instanceof MulMap)) {
      throw new ClassCastException("Comparing different types of records.");
    }
    MulMap _rio_peer = (MulMap) _rio_peer_;
    int _rio_ret = 0;
    {
  ...
  static {
    org.apache.hadoop.record.RecordComparator.define(MulMap.class, new Comparator());
  }
}
